...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    {
        $error_tglmk="Tanggal masuk sekolah tidak boleh kosong";
    }
    else
    {
    ...
    else
    {
        ...
        if (!is_numeric($nisn))
        {
            $error_skhun = 'NISN hanya boleh angka';
        }
    }
    if (empty($_POST["nik"]))
    {
    ...
    if (empty($_POST["tmpl"]))
    {
        $error_tmpl="Tempat lahir tidak boleh kosong";
    }
    else
    {
    ...
    if (empty($_POST["tgll"]))
    {
        $error_tgll="Tanggal lahir tidak boleh kosong";
    }
    else
    {
    ...
    {
        $error_camat="Kecamatan tidak boleh kosong";
    }
    else
    {
    ...
    if (empty($_POST["kwn"]))
    {
        $error_kwn="Kewaranegaraan tidak boleh kosong";
    }
    else
    {
...
<div class="card"> 
 ...
 <div class="card-body"> 
  <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>"> 
   ...
   <div class="form-group row">
     <label for="transport" class="col-sm-4 col-form-label">Moda Transport</label>
     <div class="col-sm-16 form-check">
...
$latihan = mysqli_query($conn, "INSERT INTO pendaftaran_siswa VALUES ('$tgl', '$jp', $tglmk', '$nis', '$noujian', 
'$paud', '$tk', '$skhun', '$ijazah','$hobi', '$citacita', '$nama', '$jk', '$nisn','$nik','$tmpl','$tgll','$agama', 
'$berkhus','$alamat','$rt','$rw', $dusun','$desa','$camat', '$kodepos', '$tmptinggal', '$transport','$nohp', '$notelp', 
'$email', '$kps','$nokps','$kwn', '$negara')");
if ($latihan) {
  // pesan jika data tersimpan
  echo "<script>alert('Data Berhasil Direkam'); window.location.href='formpendaftaran.php'</script>";
} else {
  // pesan jika data gagal disimpan
  echo "<script>alert('Data Gagal Direkam'); window.location.href='formpendaftaran.php'</script>";
}
} 
